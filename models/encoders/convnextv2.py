...
def convnextv2_atto(**kwargs):
    ...
    return model, BN_layer(AttnBottleneck, [40, 80, 160, 320], 3, **kwargs)


def convnextv2_femto(**kwargs):
    model = ConvNeXtV2(depths=[2, 2, 6, 2], dims=[48, 96, 192, 384], **kwargs)
    return model, BN_layer(AttnBottleneck, [48, 96, 192, 384], 3, **kwargs)


def convnext_pico(**kwargs):
    model = ConvNeXtV2(depths=[2, 2, 6, 2], dims=[64, 128, 256, 512], **kwargs)
    return model, BN_layer(AttnBottleneck, [64, 128, 256, 512], 3, **kwargs)


def convnextv2_nano(**kwargs):
    model = ConvNeXtV2(depths=[2, 2, 8, 2], dims=[80, 160, 320, 640], **kwargs)
    return model, BN_layer(AttnBottleneck, [80, 160, 320, 640], 3, **kwargs)
...
def convnextv2_huge(**kwargs):
    ...
    return model, BN_layer(AttnBottleneck, [352, 704, 1408, 2816], 3, **kwargs)
